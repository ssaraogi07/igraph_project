...
#include "config.h"*/
int igraph_bfsd(const igraph_t *graph, 
...
int main() {
  ...
  igraph_bfsd(&graph, /*root=*/0, /*roots=*/ 0, /*neimode=*/ IGRAPH_OUT, 
  ...
  igraph_bfsd(&graph, /*root=*/ 2, /*roots=*/ 0, /*neimode=*/ IGRAPH_OUT, 
       /*unreachable=*/ 1, /*restricted=*/ 0,
       0, 0, 0, 0, 0, 0, &bfs_callback, 0);
  printf("\n");
  ...
  igraph_bfsd(&graph, /*root=*/ 5, /*roots=*/ 0, /*neimode=*/ IGRAPH_OUT, 
  ...
  igraph_bfsd(&graph, /*root=*/ 4, /*roots=*/ 0, /*neimode=*/ IGRAPH_OUT, 
       /*unreachable=*/ 1, &restricted,
       0, 0, 0, 0, 0, 0, &bfs_callback, 0);
  printf("\n");  

  igraph_bfsd(&graph, /*root=*/ 3, /*roots=*/ 0, /*neimode=*/ IGRAPH_OUT, 
  ...
  VECTOR(roots)[1]=4;
  VECTOR(roots)[2]=6;
  igraph_bfsd(&graph, /*root=*/ -1, &roots, /*neimode=*/ IGRAPH_OUT, 
       /*unreachable=*/ 0, &restricted,
       0, 0, 0, 0, 0, 0, &bfs_callback, 0);
  printf("\n");    
